                        ...
                        gesture_events.append(
                            {
                                ...
                                "hand_index": h_idx,
                                "label": "thumbs_up",
                                "confidence": thumbs_up_confidence(coords, label),
                            }
                        )
                            ...
                            gesture_events.append(
                                {
                                    ...
                                    "hand_index": h_idx,
                                    "label": "wave",
                                    "confidence": min(1.0, wrist_toggle_count[h_idx] / 8.0),
                                }
                            )
...
def thumbs_up_confidence(coords: Dict[int, Tuple[float, float, float]], handedness: str) -> float:
    needed = [0, 4, 1, 2, 3, 5]
    if not all(k in coords for k in needed):
        return 0.0
    wrist_y = coords[0][1]
