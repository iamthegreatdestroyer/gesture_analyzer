...
def is_thumbs_up(
    ...
    - Side position: Right hand thumb tip x < index MCP (5) x; Left hand thumb tip x > index MCP x
    """
...
def compute_angle(
    ...
    """Return the angle in degrees at point p2 formed by segments p2->p1 and p2->p3."""
